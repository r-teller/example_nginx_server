...
local paths = {'','api','login'}
local files = {'index.html', 'home.asp', 'login.php','location.js','randomFile.me','background.jpg'}
...
function request()
    ...
    wrk.headers['delay-min'] = 100
    wrk.headers['delay-max'] = 10000
    wrk.body    = nil
